                ...
                <div class="tab-pane active" id="general">
                    <div class="tile">
                        <form action="{{ route('admin.products.update') }}" method="POST" role="form">
                            @csrf
                            <h3 class="tile-title">Information sur le Produit</h3>
                            <hr>
                            <div class="tile-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label" for="quantity">Quantité max par commande</label>
                                            <input
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="description">Déscription (HTML accepté)</label>
