...
<section class="login-content">
    ...
    <div class="login-box">
        <form class="login-form" action="{{ route('admin.login.post') }}" method="POST" role="form">
            @csrf
            <h3 class="login-head">
                <img id="login-logo" class="mb-2" src="{{ asset('frontend/images/logo.png') }}">
                
            <i class="fa fa-lg fa-fw fa-user"></i>CONNEXION</h3>
            <div class="form-group">
                <label class="control-label" for="email">Addresse Email</label>
                <input class="form-control" type="email" id="email" name="email" placeholder="Addresse Email" autofocus value="{{ old('email') }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="utility">
                    <div class="animated-checkbox">
                        <label>
                            <input type="checkbox" name="remember"><span class="label-text">Resté connecté</span>
                        </label>
                    </div>
                </div>
            </div>
